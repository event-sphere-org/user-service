...
public class UserController {
    ...
    public ResponseEntity<CollectionModel<User>> getAllUsers() {
        ...
        for (User user : users) {
            user.add(
                    linkTo(methodOn(UserController.class).getUser(user.getId())).withRel(GET_USER_REL),
                    linkTo(methodOn(UserController.class).changePassword(user.getId(), new ChangePasswordDto())).withRel(CHANGE_PASSWORD_REL)
            );
        }
    ...
    public ResponseEntity<Void> changePassword(@PathVariable Long id, @Valid @RequestBody ChangePasswordDto passwordDto) {
